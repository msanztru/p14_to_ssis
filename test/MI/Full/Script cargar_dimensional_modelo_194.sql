...
BEGIN
  ...
  INNER JOIN fnn1_query_carga_mi_documentos_194() ON (doc_194.id_documento = fnn1_query_carga_mi_documentos_194.id_documento)
  ...
  -- CRITERIOS AÑADIDOS JUNTO A LA FUNCION
  ...
  --CREAMOS DOS CTE UNO PARA CADA MERGE47
  --cte 1
  WITH cte_doc_inform_194_1
   AS (SELECT t.* from dbn1_dmr_dhyf.dbo.tbn1_dim_documentos_informativos_194_bonos_y_capitales_ajenos t INNER JOIN fnn1_query_carga_mi_documentos_194() f ON f.id_documento = t.id_documento ) 

  MERGE cte_doc_inform_194_1
  ...
  --cte 2
  WITH cte_doc_inform_194_2
   AS ( SELECT t.* FROM dbn1_dmr_dhyf.dbo.tbn1_dim_documentos_informativos_194_bonos_y_capitales_ajenos t INNER JOIN fnn1_query_carga_mi_documentos_194() f ON t.id_documento = f.id_documento)
  
  MERGE  cte_doc_inform_194_2 as tbn1_dim_documentos_informativos_194_bonos_y_capitales_ajenos
  USING #query__FF1BC AS query ON query.id_documento=tbn1_dim_documentos_informativos_194_bonos_y_capitales_ajenos.id_documento AND query.administracion_hacienda=tbn1_dim_documentos_informativos_194_bonos_y_capitales_ajenos.administracion_hacienda
...
BEGIN
  ...
  --CREAMOS DOS CTE, UNO PARA CADA MERGE
  -- primer cte  
  WITH cte_det_inform_194_1
  AS (SELECT t.* FROM dbn1_dmr_dhyf.dbo.tbn1_fact_detalles_informativos_194_bonos_y_capitales_ajenos t INNER JOIN fnn1_query_carga_mi_documentos_194() f ON t.id_documento = f.id_documento)
  MERGE cte_det_inform_194_1
  ...
  --segundo cte
  WITH cte_det_inform_194_2 
  AS (SELECT t.* FROM dbn1_dmr_dhyf.dbo.tbn1_fact_detalles_informativos_194_bonos_y_capitales_ajenos t INNER JOIN fnn1_query_carga_mi_documentos_194() f ON t.id_documento = f.id_documento)

  MERGE cte_det_inform_194_2 as tbn1_fact_detalles_informativos_194_bonos_y_capitales_ajenos
  USING #query__61B54 AS query ON query.id_detalles_194=tbn1_fact_detalles_informativos_194_bonos_y_capitales_ajenos.id_detalles_194
  WHEN MATCHED AND (NOT (query.fec_baja IS NOT NULL) AND 
