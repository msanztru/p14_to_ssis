...
IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_normalizado_documentos_informativos_194' AND ROUTINE_TYPE='PROCEDURE')
DROP PROCEDURE dbo.spn1_cargar_normalizado_documentos_informativos_194;
GO

CREATE PROCEDURE dbo.spn1_cargar_normalizado_documentos_informativos_194(@logpadre int) AS
BEGIN

  DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_documentos_informativos_194'
  SET NOCOUNT ON;
  DECLARE @log int;
  ...
  query AS (
	...
	INNER JOIN dbn1_stg_dhyf.dbo.fnn1_query_carga_mi_documentos_194() f ON (f.id_documento = doc.id_documento)
	...
	INNER JOIN dbn1_stg_dhyf.dbo.fnn1_query_carga_mi_documentos_194() ON (fnn1_query_carga_mi_documentos_194.id_documento = doc.id_documento)
    INNER JOIN dbn1_norm_dhyf.dbo.tbn1_expedientes e ON (doc.id_expediente=e.id_expediente)
  ...
  cte_doc_inform_194
  AS (SELECT dbn1_norm_dhyf.dbo.tbn1_documentos_informativos_194_bonos_y_capitales_ajenos.* from dbn1_norm_dhyf.dbo.tbn1_documentos_informativos_194_bonos_y_capitales_ajenos INNER JOIN fnn1_query_carga_mi_documentos_194() ON dbn1_norm_dhyf.dbo.tbn1_documentos_informativos_194_bonos_y_capitales_ajenos.id_documento = fnn1_query_carga_mi_documentos_194.id_documento)

  MERGE cte_doc_inform_194 as tbn1_documentos_informativos_194_bonos_y_capitales_ajenos
...
IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_normalizado_detalles_informativos_194_INTERNOS' AND ROUTINE_TYPE='PROCEDURE')
DROP PROCEDURE dbo.spn1_cargar_normalizado_detalles_informativos_194_INTERNOS;
GO

CREATE PROCEDURE dbo.spn1_cargar_normalizado_detalles_informativos_194_INTERNOS(@logpadre int) AS
BEGIN

  DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_detalles_informativos_194_INTERNOS'
  SET NOCOUNT ON;
  DECLARE @log int;
  EXECUTE @log = dbn1_stg_dhyf.dbo.spn1_apuntar_log @logpadre,@procedure_name;
  DECLARE @fecha_ultima_carga datetime=dbn1_stg_dhyf.dbo.fnn1_fecha_ultima_carga(@log);
  ...
  cte_det_inform_194_int AS (SELECT t.* FROM dbn1_norm_dhyf.dbo.tbn1_detalles_informativos_194_bonos_y_capitales_ajenos t INNER JOIN fnn1_query_carga_mi_documentos_194() f ON t.id_documento = f.id_documento)

  MERGE cte_det_inform_194_int as tbn1_detalles_informativos_194_bonos_y_capitales_ajenos
...
IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_normalizado_detalles_informativos_194_EXTERNOS_full' AND ROUTINE_TYPE='PROCEDURE')
DROP PROCEDURE dbo.spn1_cargar_normalizado_detalles_informativos_194_EXTERNOS_full;
GO

CREATE PROCEDURE dbo.spn1_cargar_normalizado_detalles_informativos_194_EXTERNOS_full(@logpadre int) AS
BEGIN

  DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_detalles_informativos_194_EXTERNOS_full'
  SET NOCOUNT ON;
  DECLARE @log int;
  EXECUTE @log = dbn1_stg_dhyf.dbo.spn1_apuntar_log @logpadre,@procedure_name;
  DECLARE @fecha_ultima_carga datetime=dbn1_stg_dhyf.dbo.fnn1_fecha_ultima_carga(@log);
  ...
  cte_det_inform_194_ext AS ( SELECT * FROM dbn1_norm_dhyf.dbo.tbn1_detalles_informativos_194_bonos_y_capitales_ajenos) -- INNER JOIN FUNCTION ON dbn1_norm_dhyf.dbo.tbn1_detalles_informativos_194_bonos_y_capitales_ajenos.id_documento = FUNCTION.id_documento

  MERGE cte_det_inform_194_ext as tbn1_detalles_informativos_194_bonos_y_capitales_ajenos
  USING query ON query.id_documento=tbn1_detalles_informativos_194_bonos_y_capitales_ajenos.id_documento AND query.secuencia=tbn1_detalles_informativos_194_bonos_y_capitales_ajenos.secuencia
...
IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_normalizado_modelo_194' AND ROUTINE_TYPE='PROCEDURE')
DROP PROCEDURE dbo.spn1_cargar_normalizado_modelo_194;
GO

CREATE PROCEDURE dbo.spn1_cargar_normalizado_modelo_194(@logpadre int) AS
BEGIN

  DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_modelo_194'
  SET NOCOUNT ON;
  DECLARE @log int;
  EXECUTE @log = dbn1_stg_dhyf.dbo.spn1_apuntar_log @logpadre,@procedure_name;
  DECLARE @fecha_ultima_carga datetime=dbn1_stg_dhyf.dbo.fnn1_fecha_ultima_carga(@log);
  ...
  EXECUTE dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_documentos_informativos_194 @log;
  EXECUTE dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_detalles_informativos_194_INTERNOS @log;
  EXECUTE dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_detalles_informativos_194_EXTERNOS @log;
