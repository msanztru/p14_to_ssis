...
-- @@stgv.mi_159, vista con los datos del DECLARANTE, DECLARADO, DOMICILIOS y REPRESENTANTES

-- @@stgv.mi_ds_159 con los datos de @@stgv.mi_159, IMPORTES y CONSUMOS


CREATE OR REPLACE VIEW @@stgv.mi_159 
select 
...
left join @@stg.domi_sd filter (sddomi_modelo='159') 
...
CREATE OR REPLACE VIEW @@stgv.mi_ds_159
COMBINE WITH UNION ALL

IMPORTES(
select 
	mi_159.id_documento 			#documento,
	mi_159.id_expediente,
	
	--datos DECLARANTE--
	mi_159.ejercicio,
	mi_159.modelo,
	
	mi_159.administracion_declarante,
	mi_159.es_externo_declarante,
	mi_159.nif_declarante_159,
	mi_159.nif_declarante_no_identificado,	
	mi_159.es_contribuyente_declarante,
	mi_159.id_contribuyente_declarante,
	mi_159.es_identificado_declarante,
	mi_159.sw_identificado_declarante, 
	
	mi_159.telefono,
	mi_159.razon_social,
	
	mi_159.cod_presentador_colectivo,
	mi_159.cod_banco_espania,
	mi_159.id_tipo_presentacion,
	mi_159.fecha_presentacion,
	mi_159.mes_presentacion,
	mi_159.anyo_presentacion,
	mi_159.num_caja,
	mi_159.num_justificante,
	mi_159.id_tipo_declaracion,
	mi_159.contador_revisiones,
	mi_159.regimen_fiscal_deducciones,
	
	--datos DECLARADO
	mi_159.administracion_declarado,
	mi_159.es_externo_declarado,
	mi_159.secuencia					#secuencia,
	mi_159.nif_declarado_159,
	mi_159.nif_declarado_no_identificado,
	mi_159.es_contribuyente_declarado,
	mi_159.id_contribuyente_declarado,  
	mi_159.es_identificado_declarado,
	mi_159.sw_identificado_declarado,
	mi_159.es_erroneo_declarado,
	
	mi_159.id_clave_tipo_codigo,
	
	mi_159.codigo_iban,
	mi_159.codigo_entidad,
	mi_159.codigo_sucursal,   
	mi_159.digito_control,    
	mi_159.codigo_cuenta,
	
	mi_159.pais_residencia,        
	mi_159.identificacion_extranjero,  
	mi_159.contrato_suministro,        
	mi_159.codigo_pais,            
	mi_159.distribuidora,             
	mi_159.numero_libre_asignacion,    
	mi_159.cups_digito_control,
	mi_159.punto_medida,            
	mi_159.punto_suministro,        
	mi_159.tipo_bien,               
	mi_159.situacion_inmueble,     
	mi_159.referencia_catastral,       
	mi_159.fecha_alta_contrato,     
	mi_159.fecha_baja_contrato,     
	mi_159.unidad_medida_consumo,      
	mi_159.unidad_medida_potencia,     
	mi_159.potencia_maxima_contratada, 
	...
	--Domicilios--
	mi_159.tipo_direccion,
	mi_159.orden,
	mi_159.num_puente_domicilio,	
	mi_159.tipo_via,
	mi_159.nombre_via,
	mi_159.tipo_numero,
	mi_159.numero_casa,
	mi_159.calificador_numero,
	mi_159.bloque,
	mi_159.portal,
	mi_159.escalera,
	mi_159.piso,
	...
	mi_159.id_municipio,
	mi_159.id_provincia,
	mi_159.codigo_postal,
	
	--Representantes--
	mi_159.nif_representante,
	mi_159.forma_juridica,
	mi_159.letra_nif_representante,
	mi_159.fecha_alta,
	mi_159.fecha_modificacion,
	mi_159.sw_baja,
	mi_159.num_puente_representante,
...
from  @@stgv.mi_159  mi_159
inner join @@stg.im59_mf importes on mi_159.ejercicio_declarado=importes.mfim59_ejercicio
								 and mi_159.administracion_declarado=importes.mfim59_admon
								 and mi_159.referencia=importes.mfim59_referdoc
								 and mi_159.secuencia=importes.mfim59_secuen
left  join @@norm.mi_tipo_importe tipo_importe on tipo_importe.cod_tipo_importe=importes.mfim59_tipo
cross join @@norm.indefinidos indefinidos								 
...
select
	...
	consumos.mfco59_con_tipo 	tipo_lectura
from  @@stgv.mi_159  mi_159	
inner join @@stg.co59_mf consumos on mi_159.ejercicio_declarado=consumos.mfco59_ejercicio
								 and mi_159.administracion_declarado=consumos.mfco59_admon
								 and mi_159.referencia=consumos.mfco59_referdoc 
								 and mi_159.secuencia=consumos.mfco59_secuen
								 inner join @@stg.im59_mf importes on mi_159.ejercicio_declarado=importes.mfim59_ejercicio
								 and mi_159.administracion_declarado=importes.mfim59_admon
								 and mi_159.referencia=importes.mfim59_referdoc
								 and mi_159.secuencia=importes.mfim59_secuen
