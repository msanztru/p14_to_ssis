...
select
	...
	declarado.mfpe59_ejercicio AS ejercicio,
...
select
	...
	domicilio.sddomi_calificador AS domi_calificador_numero,
...
into #domicilio_159	
from #cabecera_159 cabe
	 INNER JOIN dbn1_stg_dhyf.dbo.tbn1domi_sd domicilio ON cabe.ejercicio=domicilio.sddomi_ejercicio AND cabe.administracion_declarante=domicilio.sddomi_admon AND cabe.cabe_referdoc=domicilio.sddomi_referdoc
where sddomi_modelo='159'
...
inner join #cabecera_159 cabe ON cabe.ejercicio=ic.ejercicio AND cabe.administracion_declarante=ic.admon AND cabe.cabe_referdoc=ic.referdoc
...
domi_localidad
from  #cabecera_159 cabe
inner join #declarado_159 declarado ON cabe.ejercicio=declarado.ejercicio AND cabe.cabe_referdoc=declarado.referdoc --AND cabe.administracion_declarante=declarado.administracion_declarado 
inner join #domicilio_159 domicilio	ON cabe.ejercicio=domicilio.domi_ejercicio AND cabe.administracion_declarante=domicilio.domi_admon AND cabe.cabe_referdoc=domicilio.domi_referdoc
inner join #consumos_159 consumos ON cabe.ejercicio=consumos.ejercicio AND cabe.administracion_declarante=consumos.admon AND cabe.cabe_referdoc=consumos.referdoc 
