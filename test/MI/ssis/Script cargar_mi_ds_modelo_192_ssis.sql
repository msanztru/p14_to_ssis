...
IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_normalizado_mi_ds_192_operaciones_letras_tesoro_ssis_ssis' AND ROUTINE_TYPE='PROCEDURE')
DROP PROCEDURE dbo.spn1_cargar_normalizado_mi_ds_192_operaciones_letras_tesoro_ssis_ssis;
GO

CREATE PROCEDURE dbo.spn1_cargar_normalizado_mi_ds_192_operaciones_letras_tesoro_ssis_ssis(@p_id_carga int)AS
BEGIN
--- Inicio cabecera
	SET NOCOUNT ON
	BEGIN TRY
		...
		DECLARE	@bd					varchar(50)	= 'dbn1_stg_dhyf',
				...
				@objeto				varchar(200)= 'spn1_cargar_normalizado_mi_ds_192_operaciones_letras_tesoro_ssis',
...
--	DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_normalizado_mi_ds_192_operaciones_letras_tesoro_ssis_ssis'
--	SET NOCOUNT ON;
--	DECLARE @log int;
--	EXECUTE @log = dbn1_stg_dhyf.dbo.spn1_apuntar_log @p_id_carga,@procedure_name;
--	DECLARE @fecha_ultima_carga datetime=dbn1_stg_dhyf.dbo.fnn1_fecha_ultima_carga(@log);
--	DECLARE @continuar_en_caso_error bit=0;
--	IF @p_id_carga IS NOT NULL AND EXISTS (SELECT 1 AS expr1
...
----IF EXISTS (SELECT 1 FROM dbn1_stg_dhyf.INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_SCHEMA='dbo' AND ROUTINE_NAME='spn1_cargar_mi_ds_192_operaciones_letras_tesoro_ssis' AND ROUTINE_TYPE='PROCEDURE')
----DROP PROCEDURE dbo.spn1_cargar_mi_ds_192_operaciones_letras_tesoro_ssis;
----GO

----CREATE PROCEDURE dbo.spn1_cargar_mi_ds_192_operaciones_letras_tesoro_ssis(@p_id_carga int) AS
----BEGIN

----  DECLARE @procedure_name varchar(100)='dbn1_stg_dhyf.dbo.spn1_cargar_mi_ds_192_operaciones_letras_tesoro_ssis'
----  SET NOCOUNT ON;
----  DECLARE @log int;
----  EXECUTE @log = dbn1_stg_dhyf.dbo.spn1_apuntar_log @p_id_carga,@procedure_name;
----  DECLARE @fecha_ultima_carga datetime=dbn1_stg_dhyf.dbo.fnn1_fecha_ultima_carga(@log);
